...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-muted/50 dark:bg-muted border-t border-border font-medium [&>tr]:last:border-b-0",
        className
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-muted/50 dark:hover:bg-muted/50 data-[state=selected]:bg-muted dark:data-[state=selected]:bg-muted border-b border-border transition-colors duration-200",
        className
      )}
      {...props}
    />
